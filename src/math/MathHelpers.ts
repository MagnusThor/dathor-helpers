 ...
 * geometry, trigonometry, and matrix/quaternion manipulation.
 */
export class MathHelper {

    /**
     * Factory method to create a new 2D point/vector (Vec2).
     * @param x - The x-coordinate.
     * @param y - The y-coordinate.
     * @returns A new Point2D instance.
     */
    static vec2(x: number, y: number): Point2D {
        return new Point2D(x, y);
    }

    /**
     * Factory method to create a new 3D point/vector (Vec3).
     * @param x - The x-coordinate.
     * @param y - The y-coordinate.
     * @param z - The z-coordinate.
     * @returns A new Point3D instance.
     */
    static vec3(x: number, y: number, z: number): Point3D {
